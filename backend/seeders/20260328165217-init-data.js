...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("Stadiums", [
      {
        name: "Sân bóng Lam Master",
        description: "Sân cỏ chuẩn, có nước uống miễn phí",
        owner_id: 2,
        location_id: 1,
        status: "active",
        createdAt: now,
    ...
    await queryInterface.bulkInsert("FieldImages", [
      ...
      },
      {
        field_id: 2,
        image_url:
          "https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=800", // Ảnh Sân 7B
        createdAt: now,
        updatedAt: now,
      },
    ]);
    ...
    await queryInterface.bulkInsert("Notifications", [
      {
        user_id: 3,
        content: "Kiet Admin đã phê duyệt yêu cầu của bạn",
        is_read: false,
        createdAt: now,
        updatedAt: now,
      },
