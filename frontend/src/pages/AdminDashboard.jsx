...
const AdminDashboard = () => {
  ...
  // --- THÊM MỚI: Hàm xử lý gửi thông báo ---
  // --- CẬP NHẬT: Hàm xử lý gửi thông báo chuyên nghiệp hơn ---
  ...
  return (
    <div className="container-fluid p-4">
      ...
      {/* --- GIỮ NGUYÊN: Lối tắt nhanh & Trạng thái --- */}
        ...
        <div className="col-md-6 mb-4">
          <div className="card border-0 shadow-sm p-4 rounded-4 h-100">
            ...
            <div className="d-grid gap-2">
              ...
              >
                <i className="bi bi-person-gear me-2"></i> Quản lý & Phân quyền
                User
              </Link>
              <Link
                to="/admin/stadiums"
              ...
              >
                <i className="bi bi-check-circle me-2"></i> Duyệt bài đăng sân
                mới
              </Link>
            </div>
          </div>
      ...
      {/* --- THÊM MỚI: Form Gửi Thông Báo Hệ Thống --- */}
      <div className="row">
        <div className="col-12">
          <div className="card border-0 shadow-sm p-4 rounded-4">
            <h5 className="fw-bold mb-4 text-primary">
              <i className="bi bi-megaphone-fill me-2"></i> Gửi thông báo hệ
              thống
            </h5>
