...
const MainLayout = () => {
  ...
  const roleId = Number(currentUser?.role_id || currentUser?.role || user?.role_id || user?.role || 0);
            ...
            <ul className="navbar-nav ms-lg-4 gap-3">
              ...
              {isOwner && (
                <li className="nav-item d-flex align-items-center gap-1 ms-lg-3 ps-lg-3 border-start">
                  ...
                  <Link
                    className="nav-link px-2"
                    style={getLinkStyle('/owner/reviews')}
                    to="/owner/reviews"
                  >
                    <div className="d-flex align-items-center gap-1">
                      <i className="bi bi-star-fill text-warning"></i>
                      <span style={{ fontSize: '14px' }}>Danh gia</span>
                    </div>
                  </Link>
                  ...
                  >
                    <div className="d-flex align-items-center gap-1">
                      ...
                      <span style={{ fontSize: '14px' }}>Thanh toan</span>
                    </div>
                  </Link>
                </li>
              )}
      ...
      >
        ...
        <div className="mb-4">
          ...
          <Link
            ...
            onClick={handleSidebarClose}
            className="d-flex align-items-center gap-2 rounded-4 p-3 mb-3 text-decoration-none"
            style={{ background: '#fff8f1', color: '#1f2937' }}
          >
